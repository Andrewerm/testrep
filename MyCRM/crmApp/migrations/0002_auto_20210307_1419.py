# Generated by Django 2.2.17 on 2021-03-07 11:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='AvangardProducts',
            fields=[
                ('code', models.SmallIntegerField(primary_key=True, serialize=False, verbose_name='Уникальный артикул товара')),
                ...
                ('size', models.CharField(max_length=20, verbose_name='Размер часов')),
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='RUB', max_digits=7, max_length=8, verbose_name='Оптовая базовая цена')),
                ('url', models.URLField(verbose_name='Адрес товара нс сайте Аванграда')),
                ('folder_alias', models.CharField(max_length=50, verbose_name='Иерархия синонимов папки ')),
                ('folder_name', models.CharField(max_length=50, verbose_name='Иерархия имен папки ')),
